...
#define MOTOR_ENA_PIN 21
#define MOTOR_A1_PIN 18
#define MOTOR_A2_PIN 19
...
#define ssid "LAPTOPGAJQJELE"
#define password "pY103066"
...
int basePWM(float targetVel) {
    // Adjust values empirically for your motor/driver
    const int n = 5;
    float speeds[n] = {0, 300, 700, 1000, 1300};
    int pwms[n] = {0, 100, 300, 600, 800}; // scaled for 10-bit PWM
